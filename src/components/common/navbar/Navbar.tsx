...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full bg-background transition-transform duration-300 ease-in-out z-50 
        ${isVisible ? "translate-y-0 shadow-md" : "-translate-y-full"} `}
    >
      <div className="container max-container padding-container flex items-center justify-between gap-10 py-3">
        <Logo />
        ...
        >
          <div className="w-10 h-10 flexCenter">
            ...
            />
            <span
              className={`block absolute h-0.5 w-6 md:w-10 bg-current transition-opacity duration-300 ease-in-out ${
