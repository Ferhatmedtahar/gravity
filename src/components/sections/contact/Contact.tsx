...
export default function Contact() {
  return (
    ...
    >
      <div className="flex flex-col md:flex-row gap-20 items-center max-w-4xl ">
        ...
        <div className="flex flex-col text-center md:text-start ">
          <p className="  text-sm sm:text-base md:text-lg leading-8 sm:max-w-md md:max-w-xl mx-auto my-4 md:my-6">
          ...
          <p className="  text-sm sm:text-base md:text-lg leading-8 sm:max-w-md md:max-w-xl mx-auto my-1 md:my-2">
      ...
      <div className="relative flexCenter flex-col gap-3 sm:gap-4 md:gap-6 lg:gap-8">
        <h2 className="uppercase text-xl sm:text-3xl md:text-4xl   ">
          contact us
        </h2>

        <p className="text-center text-sm sm:text-base md:text-lg leading-8 sm:max-w-md md:max-w-xl mx-auto ">
